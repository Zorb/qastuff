...
public class Runner3 {
	...
	/*
	 * Precondition: a new instance of Blackjack has been created. Postcondition:
	 * the player will play Blackjack for the number of desired games. End
	 * statistics of gameplay will be printed at the end.
	 */
	public void play() {
		shuffleDeck();
	...
	/*
	 * Precondition: card decks have been created and shuffled. Postcondition: the
	 * end result of the game will be printed.
	 */
	public void playGame() {
		...
		if (insurance) {
			if (dealersCard2.substring(0, 1).equals("1") || dealersCard2.substring(0, 1).equals("J")
					|| dealersCard2.substring(0, 1).equals("Q") || dealersCard2.substring(0, 1).equals("K")) {
		...
		if (hasBlackjack(playersCard1.substring(0, 1), playersCard2.substring(0, 1)))
			...
			playerAction = getPlayerAction(dealersCard1.substring(0, 1), playersCard1.substring(0, 1),
					playersCard2.substring(0, 1));
	...
	/*
	 * Precondition: minBet and trueCount exists. Postcondition: a bet based on
	 * trueCount is placed and total chips is updated.
	 */
	...
	/*
	 * Precondition: dealer's visible card is passed. Postcondition: will either
	 * call itself to hit or player stands.
	 */
	 ...
	 * Postcondition: will either call itself to hit or player stands.
	 */
	 ...
	 * Postcondition: will either call itself to hit on each hand or player stands
	 * on each hand.
	 */
	...
	/*
	 * Precondition: dealer's visible card is passed. Postcondition: player's action
	 * is returned.
	 */
		...
		if (plist.contains("A")) {
			...
			for (int x = 0; x < plist.size(); x++) {
				if (!plist.get(x).equals("A")) {
					if (plist.get(x).equals("1") || plist.get(x).equals("J") || plist.get(x).equals("Q")
							|| plist.get(x).equals("K"))
						cardSum += 10;
					else
		...
		if (plist2.contains("A")) {
			...
			for (int x = 0; x < plist2.size(); x++) {
				if (!plist2.get(x).equals("A")) {
					if (plist2.get(x).equals("1") || plist2.get(x).equals("J") || plist2.get(x).equals("Q")
							|| plist2.get(x).equals("K"))
						cardSum += 10;
					else
	...
	/*
	 * Preconditions: two cards are passed. Postconditions: condition of blackjack
	 * is returned.
	 */
	public boolean hasBlackjack(String card1, String card2) {
		...
		else if ((card2.equals("1") || card2.equals("J") || card2.equals("Q") || card2.equals("K"))
				&& (card1.equals("A")))
			return true; // has Blackjack
		else
	...
	/*
	 * Preconditions: player's first two cards and visible dealer card is passed
	 * through parameter. Postconditions: best suited action is returned based on
	 * basic game play strategy table.
	 */
	...
	/*
	 * Precondition: both of player's first dealt cards are passed. Postcondition:
	 * the player's hand index for strategy table is returned.
	 */
	...
	/*
	 * Precondition: dealer's visible card passed through parameter. Postcondition:
	 * the dealer's hand index for strategy table is returned.
	 */
		...
		if (dlist.contains("A")) {
			...
			for (int x = 0; x < dlist.size(); x++) {
				if (!dlist.get(x).equals("A")) {
					if (dlist.get(x).equals("1") || dlist.get(x).equals("J") || dlist.get(x).equals("Q")
							|| dlist.get(x).equals("K"))
						dealerCardSum += 10;
					else
